              ...
              <div className="itemeach">
                <div className="itempicture">
                  <img
                    ...
                    width="240px"
                    height="240px"
                    src="https://img.freepik.com/free-photo/portrait-beautiful-face-young-smiling-woman-with-long-brown-hair-red-dress_186202-6493.jpg?w=740&t=st=1690136068~exp=1690136668~hmac=05ea6a3d06e01e8f360be484288181a0c6d167255f6f20b4f1c27e6ba4bdb037"
                    alt=""
                  />
                </div>
                <div className="itemdetails">
                  <div className="nameandrate">
                    <div className="nameofitem">
                      <span className="itemhead">BLACK</span>
                    </div>
                    <div className="price">
                      <ul>
                        {" "}
                        <li>
                          <span className="originalprice">₹ 500/- </span>
                          <span className="oldprice">₹ 800/-</span>
                        </li>
                        <li>
                          {" "}
                          <span className="offertext">
            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Red hair comes in a variety of shades, including copper, auburn, strawberry blonde, and deep burgundy. This wide range of red tones allows individuals to choose the shade that best complements their skin tone and personal style.
                  </span>
