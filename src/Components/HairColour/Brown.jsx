            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Brown hair is a common hair color found in individuals with a range of skin tones and ethnic backgrounds.

Versatility: Brown hair serves as a versatile base for hair color transformations. It can be enhanced with highlights          </span>
