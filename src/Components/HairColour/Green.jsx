            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Light or pastel shades of green, such as mint green or pale sage, paired with bright white can create a calming and natural ambiance reminiscent of nature and the outdoors. This color combination is often associated with tranquility, balance, and a sense of freshness.     </span>
