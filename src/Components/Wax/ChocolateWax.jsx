...
const ChocolateWax = () => {
      ...
      <div className="facialmaindivsecond">
        <div className="facialtotalbox">
          <div className="itembox">
            {/* 1 */}
            <Link className='textdecoration' to="/Waxing"><div className="itemeach">
 ...
 <Link className="textdecoration" to="/GelWax">
  <div className="itemeach"> 
<div className="itempicture">
<img className="imageofitems" width="240px" height="240px" src="https://img.freepik.com/free-photo/woman-with-beautiful-body-using-cream-her-leg-white-background_186202-7250.jpg?w=740&t=st=1690021228~exp=1690021828~hmac=150858d6b4a45d60108a3f934d833505bc94b1731b98b13ea55291e36504bc44"alt="" />
</div>
<div className="itemdetails">
    <div className="nameandrate">
   <div className="nameofitem"><span className="itemhead">GEL WAX</span></div> 
    <div className="price">
            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Chocolate wax has a delightful cocoa aroma, making the waxing experience more enjoyable for some people compared to the usual scents of regular wax.

Moisturizing: The cocoa content in chocolate wax provides moisturizing benefits to the skin, leaving it feeling soft and hydrated after the hair removal process
                  </span>
