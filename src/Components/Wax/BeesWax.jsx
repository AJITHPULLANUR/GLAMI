            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Beeswax is a popular material for making candles due to its natural properties. It burns cleanly, emits a subtle honey-like aroma, and produces very little soot when compared to other candle waxes.
                  </span>
