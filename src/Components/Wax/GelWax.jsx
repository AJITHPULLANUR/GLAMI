            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Gel wax is a type of wax used in candle-making. It is a translucent, rubbery, and gel-like substance that can hold a high concentration of fragrance and color. Gel candles are known for their clarity 
                  </span>
