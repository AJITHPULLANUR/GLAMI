      ...
      <div className="facialmaindivsecond">
        <div className="facialtotalbox">
          <div className="itembox">
            {/* 1 */}
            <Link className="textdecoration" to="/MetalicThreading" ><div className="itemeach">
        ...
        <input className="booknowbutton" type="button" value="BOOK NOW" />
            ...
            {/* 3 */}
 {/* last work.................................... */}
            <Link className='textdecoration' to="/PolysterThreading" ><div className="itemeach"> 
<div className="itempicture">
<img className="imageofitems" width="240px" height="240px" src="https://img.freepik.com/free-photo/master-doing-final-steps-make-up-procedure-model-with-green-eyes_231208-3580.jpg?w=360&t=st=1690046458~exp=1690047058~hmac=372e7d01c6535537e9b3cc5d07d83a7bd5f483fea9f64d42e81168e8bcc650ef"alt="" />
</div>
<div className="itemdetails">
    <div className="nameandrate">
   <div className="nameofitem"><span className="itemhead">POLYSTER THREADING</span></div> 
    <div className="price">
            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Buttress threading, also known as buttress thread, is a type of thread profile used in mechanical engineering and various industrial applications. It is characterized by its asymmetrical shape                  </span>
...
export default ButtressThreading