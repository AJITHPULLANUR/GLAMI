            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  A "square thread" typically refers to a type of thread profile where the threads have a square cross-section, meaning the width and depth of the thread are the same. Square threads are used in various applications                  </span>
...
export default SqaureThreading