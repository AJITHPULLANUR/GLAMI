            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Polyester thread is a type of sewing thread made from polyester fibers. It is widely used in the textile and garment industry for sewing fabrics and creating various clothing items, accessories, and home textiles. 
                  </span>
...
export default PolysterThreading;
