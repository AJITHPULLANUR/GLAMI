            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Hairstyles can vary widely among different cultures and regions, and there is often a great diversity of haircuts and styling preferences within any given country or ethnic group. Hairstyle                  </span>
