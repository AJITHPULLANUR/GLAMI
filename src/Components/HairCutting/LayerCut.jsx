            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  A layer cut, also known as a layered haircut, is a versatile and popular hairstyle where the hair is cut into different lengths or layers, creating a dimensional and textured look. In a layer cut, the hair is typically cut at various angles                   </span>
