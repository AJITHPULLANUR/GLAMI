            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  A step cut, also known as a step-layered cut or step haircut, is a type of hairstyle characterized by distinct and defined horizontal layers. In a step cut, the hair is cut into layers with each layer appearing as a step or stair-like pattern, hence the name "step cut"                </span>
