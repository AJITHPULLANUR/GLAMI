            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  The process starts with the application of a base coat to the natural nails. The base coat helps the dip powder adhere to the nails.

Dip Powder Application: After the base coat, the nails are dipped into a jar of colored powder. The powder                    </span>
