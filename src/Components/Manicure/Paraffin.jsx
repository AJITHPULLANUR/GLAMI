            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  The manicure starts with the usual nail care steps, such as cleaning, shaping, and buffing the nails, and pushing back or removing cuticles.

Exfoliation (Optional): Some paraffin manicures may include a gentle exfoliation of the hands and forearms                  </span>
