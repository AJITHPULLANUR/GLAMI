   ...
   <div className="nameofitem"><span className="itemhead">AYURVEDIC FACIAL</span></div> 
    ...
    <div className="itemeach2">
      <div className="pointsdiv">
        <span>Well-Illuminated Face: Could mean a face that appears bright and clear under specific lighting conditions, such as well-lit environments or in photographs.

High-Contrast Features: Refers to facial features with a noticeable contrast between different elements, such as well-defined cheekbones, a sharp jawline, or bright eyes.</span>
