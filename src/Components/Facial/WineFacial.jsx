   ...
   <div className="nameofitem"><span className="itemhead">AYURVEDIC FACIAL</span></div> 
    ...
    <div className="itemeach2">
      <div className="pointsdiv">
        <span>Cleansing: The skin is cleansed to remove any makeup, dirt, or impurities.

Exfoliation: An exfoliating scrub may be used to remove dead skin cells and improve skin texture.

Wine Mask: A mask made from red wine is applied to the face to provide antioxidants and potential skin-nourishing benefits.</span>
