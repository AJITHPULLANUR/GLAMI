...
{/* 5 */}
<Link className='textdecoration' to="/AyurvedicFacial"><div className="itemeach">
<div className="itempicture">
   ...
   <div className="nameofitem"><span className="itemhead">AYURVEDIC FACIAL</span></div> 
    ...
    <div className="itemeach2">
      <div className="pointsdiv">
        <span>Papaya: Contains enzymes that help exfoliate dead skin cells and promote skin renewal.

Pineapple: Contains bromelain, an enzyme that aids in exfoliation and brightening the skin.

Banana: Rich in vitamins and antioxidants that nourish and moisturize the skin,

Strawberry: Contains alpha hydroxy acids  help exfoliate and improve skin texture.</span>
