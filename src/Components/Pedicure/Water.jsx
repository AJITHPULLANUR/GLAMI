            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Instead of soaking the feet in water, the feet are cleansed using a mild cleanser or sanitizing solution. A disposable towel or wipes may be used to clean the feet thoroughly.                   </span>
