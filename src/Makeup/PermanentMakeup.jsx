            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  The permanent makeup procedure involves using a specialized machine or handheld tool to implant pigments into the top layer of the skin. A trained and experienced technician or permanent makeup artist performs the procedure. Prior to the application, the technician will consult with the client to determine
                  </span>
