            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Flawless Complexion: Celebrity makeup often features a flawless and well-prepared complexion. The skin is usually even-toned, with any imperfections expertly concealed using foundation and concealer.
                  </span>
...
export default CelibrityMakeup