      ...
      <div className="facialmaindivsecond">
        <div className="facialtotalbox">
          <div className="itembox">
            {/* 1 */}
           <Link className='textdecoration' to="/BridalMakeup"> <div className="itemeach">
              ...
              <div className="itemdetails">
                <div className="nameandrate">
                  <div className="nameofitem">
                    <span className="itemhead">BRIDAL FACIAL</span>
                  </div>
                  <div className="price">
                    <ul>
                      {" "}
            ...
            <Link className="textdecoration" to="/HdMakeup">
              <div className="itemeach">
                ...
                <div className="itemdetails">
                  <div className="nameandrate">
                    <div className="nameofitem">
                      <span className="itemhead">HD FACIAL</span>
                    </div>
                    <div className="price">
                      <ul>
                        {" "}
              ...
              <div className="itemeachmain">
                <div className="itempicture">
                  <img
                    ...
                    width="240px"
                    height="240px"
                    src="https://img.freepik.com/free-photo/portrait-beautiful-woman-with-make-up-brushes-near-attractive-face-adult-girll-posing-white-space_186202-4026.jpg?w=740&t=st=1690015586~exp=1690016186~hmac=2600f86c9e1357f2d757febe52cec436800fbada2c6b445076bc98ae67b9d78a"
                    alt=""
                  />
                </div>
                <div className="itemdetails">
                  <div className="nameandrate">
                    <div className="nameofitem">
                      <span className="itemhead">HEWY MAKEUP</span>
                    </div>
                    <div className="price">
                      <ul>
                        {" "}
                        <li>
                          <span className="originalprice">₹ 2540/- </span>
                        ...
                        <li>
                          {" "}
                          <span className="offertext">Save Upto ₹ 460/</span>
                        </li>
                      </ul>
                    </div>
                    <div className="time">
            ...
            <div className="itembox2">
              <div className="itemeach2">
                <div className="pointsdiv">
                  <span>
                  Foundation: Used to create an even skin tone and cover imperfections, providing a base for the rest of the makeup.

Concealer: Used to hide specific blemishes, dark circles, or discolorations on the skin.

Powder: Applied to  giving the skin a matte finish.

Blush: Used to add a healthy flush of color to the cheeks.
                  </span>
